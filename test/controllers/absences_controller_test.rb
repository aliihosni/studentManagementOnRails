...
class AbsencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create absence" do
    assert_difference('Absence.count') do
      post absences_url, params: { absence: { cour_id: @absence.cour_id, date: @absence.date, justif: @absence.justif, status: @absence.status, student_id: @absence.student_id } }
    end
  ...
  test "should update absence" do
    patch absence_url(@absence), params: { absence: { cour_id: @absence.cour_id, date: @absence.date, justif: @absence.justif, status: @absence.status, student_id: @absence.student_id } }
